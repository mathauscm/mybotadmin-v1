...
//       const mockCrusts = [
//         { id: '1', name: 'Sem borda recheada', price: 0 },
...
//       return mockCrusts;
//     } catch (error) {
//       throw new Error('Erro ao buscar bordas de pizza');
//     }
//   };
...
//       const updatedCrusts = crusts.map(crust => {
//         if (crust.id === editingId) {
//           return {
//             ...crust,
//             name: newCrust.name,
...
//       setCrusts(updatedCrusts);
//       setEditMode(false);
//       setEditingId(null);
//     } else {
//       // Cria uma nova borda
//       const newId = (crusts.length + 1).toString();
//       const createdCrust = {
//         id: newId,
//         name: newCrust.name,
//         price: parseFloat(newCrust.price) || 0
...
//   const handleDeleteCrust = (id) => {
//     if (window.confirm('Tem certeza que deseja excluir esta borda?')) {
//       // Em produção, substituir por uma chamada à API para deletar a borda
//       setCrusts(crusts.filter(crust => crust.id !== id));
//     }
//   };
